...
set(IL_FILE_PATCH "${CMAKE_CURRENT_BINARY_DIR}/DetoursNetLoader.patch.il")

message(STATUS "Patch intermediate language")
file(STRINGS "${CMAKE_CURRENT_BINARY_DIR}/DetoursNetLoaderInitial.il" IL_FILE_CONTENTS)
...
foreach(LINE ${IL_FILE_CONTENTS})
	...
	elseif(${LINE} STREQUAL	"  .method public hidebysig static void  DetoursNetLoader_Start() cil managed")
		file(APPEND ${IL_FILE_PATCH} "${LINE}\n")
		set(LOAD_HEADER true)
	elseif(${LINE} MATCHES " *{$")
		file(APPEND ${IL_FILE_PATCH} "${LINE}\n")
		if(${LOAD_HEADER})
			file(APPEND ${IL_FILE_PATCH} ".export [1] as DetoursNetLoader_Start\n.vtentry 1 : 1\n")
